...
public class Employee {
	// Legyen egy osztályszintû adattagja a nyugdíjkorhatár tárolására, értéke
	// kezdetben legyen 65.
	...
	// Legyen metódusa, amely String-be összefûzve adja vissza az Alkalmazott
	// adatait, hozzáfûzve a nyugdíjig hátrelevõ éveinek számát is.
	@Override
	 ...
	 * és hamisat ha nem; adja vissza a fizetendõ adó értéket, ha az adókulcs 16% ;
	 * 
